# sb::TextUtil - Module for Serene Bach
...
package sb::Text::sha;
use strict;
use vars qw( $VERSION $PUREPERL );
$VERSION = '0.00';
# 0.00 [2009/05/26] generated
# --------------------------------------
# // initializer
BEGIN
{
...
sub hmac_base64
{
	...
	my $option = shift;
	return ( $PUREPERL ) 
		? &Digest::SHA::PurePerl::hmac_sha256_base64($text,$option)
		: &Digest::SHA::hmac_sha256_base64($text,$option);
}
